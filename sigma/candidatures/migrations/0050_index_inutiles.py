...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute("ALTER TABLE `candidatures_appel` DROP FOREIGN KEY `code_budgetaire_refs_code_5e812767`;")
        cursor.execute("ALTER TABLE candidatures_appel DROP INDEX sigma_appel_code_budgetaire_id;");
