...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('candidatures_dossieraccueil', 'pays_id')

        # Deleting field 'DossierOrigine.pays'
        db.delete_column('candidatures_dossierorigine', 'pays_id')


    def backwards(self, orm):
        # Adding field 'DossierAccueil.pays'
        db.add_column('candidatures_dossieraccueil', 'pays',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='accueil_pays', to_field='code', null=True, to=orm['references.Pays'], blank=True),
                      keep_default=False)

        # Adding field 'DossierOrigine.pays'
        db.add_column('candidatures_dossierorigine', 'pays',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='origine_pays', to_field='code', null=True, to=orm['references.Pays'], blank=True),
                      keep_default=False)
