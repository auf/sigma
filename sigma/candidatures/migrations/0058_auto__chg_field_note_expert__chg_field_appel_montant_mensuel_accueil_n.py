...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Note.expert'
        db.alter_column('candidatures_note', 'expert_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['candidatures.Expert'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Note.expert'
        raise RuntimeError("Cannot reverse this migration. 'Note.expert' and its values cannot be restored.")
