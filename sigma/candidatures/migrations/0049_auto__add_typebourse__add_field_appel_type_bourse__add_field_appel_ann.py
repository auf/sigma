...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeBourse'
        db.create_table('candidatures_typebourse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('candidatures', ['TypeBourse'])

        # Adding field 'Appel.type_bourse'
        db.add_column('candidatures_appel', 'type_bourse',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['candidatures.TypeBourse'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Appel.annee'
        db.add_column('candidatures_appel', 'annee',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TypeBourse'
        db.delete_table('candidatures_typebourse')

        # Deleting field 'Appel.type_bourse'
        db.delete_column('candidatures_appel', 'type_bourse_id')

        # Deleting field 'Appel.annee'
        db.delete_column('candidatures_appel', 'annee')
    ...
    models = {
        ...
        'candidatures.typepiece': {
            ...
            'appel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pieces_attendues'", 'to': "orm['candidatures.Appel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
