...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Diplome.etablissement_nom'
        db.delete_column('sigma_diplome', 'etablissement_nom')

        # Deleting field 'Diplome.etablissement_pays'
        db.delete_column('sigma_diplome', 'etablissement_pays_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Diplome.etablissement_nom'
        db.add_column('sigma_diplome', 'etablissement_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Diplome.etablissement_pays'
        db.add_column('sigma_diplome', 'etablissement_pays', self.gf('django.db.models.fields.related.ForeignKey')(related_name='etablissement_pays', null=True, to=orm['datamaster_modeles.Pays'], blank=True), keep_default=False)
