...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('candidatures_appel', 'code_budgetaire', self.gf('django.db.models.fields.CharField')(default=0, max_length=72))

    def backwards(self, orm):

        # Changing field 'Appel.code_budgetaire'
        db.alter_column('candidatures_appel', 'code_budgetaire', self.gf('django.db.models.fields.CharField')(max_length=72, null=True))
