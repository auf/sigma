...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierMobilite.dir_acc_courriel'
        db.delete_column('sigma_dossiermobilite', 'dir_acc_courriel')

        # Deleting field 'DossierMobilite.dir_acc_telephone'
        db.delete_column('sigma_dossiermobilite', 'dir_acc_telephone')

        # Deleting field 'DossierMobilite.dir_ori_prenom'
        db.delete_column('sigma_dossiermobilite', 'dir_ori_prenom')

        # Deleting field 'DossierMobilite.dir_acc_nom'
        db.delete_column('sigma_dossiermobilite', 'dir_acc_nom')

        # Deleting field 'DossierMobilite.dir_ori_telephone'
        db.delete_column('sigma_dossiermobilite', 'dir_ori_telephone')

        # Deleting field 'DossierMobilite.dir_ori_civilite'
        db.delete_column('sigma_dossiermobilite', 'dir_ori_civilite')

        # Deleting field 'DossierMobilite.dir_ori_courriel'
        db.delete_column('sigma_dossiermobilite', 'dir_ori_courriel')

        # Deleting field 'DossierMobilite.dir_acc_civilite'
        db.delete_column('sigma_dossiermobilite', 'dir_acc_civilite')

        # Deleting field 'DossierMobilite.dir_acc_prenom'
        db.delete_column('sigma_dossiermobilite', 'dir_acc_prenom')

        # Deleting field 'DossierMobilite.dir_ori_nom'
        db.delete_column('sigma_dossiermobilite', 'dir_ori_nom')
    
    
    def backwards(self, orm):
        
        # Adding field 'DossierMobilite.dir_acc_courriel'
        db.add_column('sigma_dossiermobilite', 'dir_acc_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_acc_telephone'
        db.add_column('sigma_dossiermobilite', 'dir_acc_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_ori_prenom'
        db.add_column('sigma_dossiermobilite', 'dir_ori_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_acc_nom'
        db.add_column('sigma_dossiermobilite', 'dir_acc_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_ori_telephone'
        db.add_column('sigma_dossiermobilite', 'dir_ori_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_ori_civilite'
        db.add_column('sigma_dossiermobilite', 'dir_ori_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_ori_courriel'
        db.add_column('sigma_dossiermobilite', 'dir_ori_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_acc_civilite'
        db.add_column('sigma_dossiermobilite', 'dir_acc_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_acc_prenom'
        db.add_column('sigma_dossiermobilite', 'dir_acc_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.dir_ori_nom'
        db.add_column('sigma_dossiermobilite', 'dir_ori_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
