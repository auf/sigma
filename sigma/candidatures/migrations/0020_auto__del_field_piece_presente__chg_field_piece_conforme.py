...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Piece.conforme'
        db.alter_column('sigma_piece', 'conforme', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Piece.conforme'
        db.alter_column('sigma_piece', 'conforme', self.gf('django.db.models.fields.BooleanField')(blank=True))
