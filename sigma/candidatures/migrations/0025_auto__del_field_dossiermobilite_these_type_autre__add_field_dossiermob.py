...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierMobilite.these_type_autre'
        db.delete_column('sigma_dossiermobilite', 'these_type_autre')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DossierMobilite.these_type_autre'
        db.add_column('sigma_dossiermobilite', 'these_type_autre', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
