...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appel.montant_mensuel_accueil_nord'
        db.alter_column('candidatures_appel', 'montant_mensuel_accueil_nord', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.montant_mensuel_accueil_sud'
        db.alter_column('candidatures_appel', 'montant_mensuel_accueil_sud', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.montant_mensuel_origine_nord'
        db.alter_column('candidatures_appel', 'montant_mensuel_origine_nord', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.montant_allocation_unique'
        db.alter_column('candidatures_appel', 'montant_allocation_unique', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.montant_mensuel_origine_sud'
        db.alter_column('candidatures_appel', 'montant_mensuel_origine_sud', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.montant_perdiem_nord'
        db.alter_column('candidatures_appel', 'montant_perdiem_nord', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.prime_installation_nord'
        db.alter_column('candidatures_appel', 'prime_installation_nord', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.prime_installation_sud'
        db.alter_column('candidatures_appel', 'prime_installation_sud', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Appel.montant_perdiem_sud'
        db.alter_column('candidatures_appel', 'montant_perdiem_sud', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Appel.montant_mensuel_accueil_nord'
        db.alter_column('candidatures_appel', 'montant_mensuel_accueil_nord', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.montant_mensuel_accueil_sud'
        db.alter_column('candidatures_appel', 'montant_mensuel_accueil_sud', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.montant_mensuel_origine_nord'
        db.alter_column('candidatures_appel', 'montant_mensuel_origine_nord', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.montant_allocation_unique'
        db.alter_column('candidatures_appel', 'montant_allocation_unique', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.montant_mensuel_origine_sud'
        db.alter_column('candidatures_appel', 'montant_mensuel_origine_sud', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.montant_perdiem_nord'
        db.alter_column('candidatures_appel', 'montant_perdiem_nord', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.prime_installation_nord'
        db.alter_column('candidatures_appel', 'prime_installation_nord', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.prime_installation_sud'
        db.alter_column('candidatures_appel', 'prime_installation_sud', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Appel.montant_perdiem_sud'
        db.alter_column('candidatures_appel', 'montant_perdiem_sud', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'candidatures.appel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'montant_allocation_unique': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'montant_mensuel_accueil_nord': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'montant_mensuel_accueil_sud': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'montant_mensuel_origine_nord': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'montant_mensuel_origine_sud': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'montant_perdiem_nord': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'montant_perdiem_sud': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'prime_installation_nord': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'prime_installation_sud': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'candidatures.note': {
            ...
            'expert': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['candidatures.Expert']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
