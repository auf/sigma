...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Candidat.courriel_perso'
        db.alter_column('sigma_candidat', 'courriel_perso', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Candidat.courriel_perso'
        db.alter_column('sigma_candidat', 'courriel_perso', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
