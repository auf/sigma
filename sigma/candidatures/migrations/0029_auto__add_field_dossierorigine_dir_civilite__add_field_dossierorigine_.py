...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DossierOrigine.dir_civilite'
        db.add_column('sigma_dossierorigine', 'dir_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.dir_telephone'
        db.add_column('sigma_dossierorigine', 'dir_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.dir_courriel'
        db.add_column('sigma_dossierorigine', 'dir_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.dir_prenom'
        db.add_column('sigma_dossierorigine', 'dir_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.dir_nom'
        db.add_column('sigma_dossierorigine', 'dir_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.dir_civilite'
        db.add_column('sigma_dossieraccueil', 'dir_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.dir_telephone'
        db.add_column('sigma_dossieraccueil', 'dir_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.dir_courriel'
        db.add_column('sigma_dossieraccueil', 'dir_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.dir_prenom'
        db.add_column('sigma_dossieraccueil', 'dir_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.dir_nom'
        db.add_column('sigma_dossieraccueil', 'dir_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'DossierOrigine.dir_civilite'
        db.delete_column('sigma_dossierorigine', 'dir_civilite')

        # Deleting field 'DossierOrigine.dir_telephone'
        db.delete_column('sigma_dossierorigine', 'dir_telephone')

        # Deleting field 'DossierOrigine.dir_courriel'
        db.delete_column('sigma_dossierorigine', 'dir_courriel')

        # Deleting field 'DossierOrigine.dir_prenom'
        db.delete_column('sigma_dossierorigine', 'dir_prenom')

        # Deleting field 'DossierOrigine.dir_nom'
        db.delete_column('sigma_dossierorigine', 'dir_nom')

        # Deleting field 'DossierAccueil.dir_civilite'
        db.delete_column('sigma_dossieraccueil', 'dir_civilite')

        # Deleting field 'DossierAccueil.dir_telephone'
        db.delete_column('sigma_dossieraccueil', 'dir_telephone')

        # Deleting field 'DossierAccueil.dir_courriel'
        db.delete_column('sigma_dossieraccueil', 'dir_courriel')

        # Deleting field 'DossierAccueil.dir_prenom'
        db.delete_column('sigma_dossieraccueil', 'dir_prenom')

        # Deleting field 'DossierAccueil.dir_nom'
        db.delete_column('sigma_dossieraccueil', 'dir_nom')
    ...
    models = {
        ...
        'sigma.diplome': {
            ...
            'autre_etablissement_pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'etablissement_pays'", 'blank': 'True', 'null': 'True', 'to': "orm['datamaster_modeles.Pays']"}),
        ...
        'sigma.dossiermobilite': {
            ...
            'dir_acc_courriel': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'dir_acc_telephone': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'dir_ori_civilite': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'dir_ori_courriel': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'dir_ori_telephone': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'discipline': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['datamaster_modeles.Discipline']", 'null': 'True', 'blank': 'True'}),
