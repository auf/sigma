...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Appel.code_budgetaire' to match new field type.
        db.rename_column('sigma_appel', 'code_budgetaire', 'code_budgetaire_id')
        ...
        # Adding index on 'Appel', fields ['code_budgetaire']
        db.create_index('sigma_appel', ['code_budgetaire_id'])
    
    
    def backwards(self, orm):
        
        # Renaming column for 'Appel.code_budgetaire' to match new field type.
        db.rename_column('sigma_appel', 'code_budgetaire_id', 'code_budgetaire')
        # Changing field 'Appel.code_budgetaire'
        db.alter_column('sigma_appel', 'code_budgetaire', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Removing index on 'Appel', fields ['code_budgetaire']
        db.delete_index('sigma_appel', ['code_budgetaire_id'])
