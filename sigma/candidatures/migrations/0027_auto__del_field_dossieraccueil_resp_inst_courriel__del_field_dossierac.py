...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierAccueil.resp_inst_courriel'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_courriel')

        # Deleting field 'DossierAccueil.resp_inst_fonction'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_fonction')

        # Deleting field 'DossierAccueil.resp_inst_telephone'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_telephone')

        # Deleting field 'DossierAccueil.resp_inst_nom'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_nom')

        # Deleting field 'DossierAccueil.resp_inst_fax'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_fax')

        # Deleting field 'DossierAccueil.resp_inst_civilite'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_civilite')

        # Deleting field 'DossierAccueil.resp_inst_prenom'
        db.delete_column('sigma_dossieraccueil', 'resp_inst_prenom')
    
    
    def backwards(self, orm):
        
        # Adding field 'DossierAccueil.resp_inst_courriel'
        db.add_column('sigma_dossieraccueil', 'resp_inst_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.resp_inst_fonction'
        db.add_column('sigma_dossieraccueil', 'resp_inst_fonction', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.resp_inst_telephone'
        db.add_column('sigma_dossieraccueil', 'resp_inst_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.resp_inst_nom'
        db.add_column('sigma_dossieraccueil', 'resp_inst_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.resp_inst_fax'
        db.add_column('sigma_dossieraccueil', 'resp_inst_fax', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.resp_inst_civilite'
        db.add_column('sigma_dossieraccueil', 'resp_inst_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.resp_inst_prenom'
        db.add_column('sigma_dossieraccueil', 'resp_inst_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
