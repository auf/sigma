...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conformite.commentaire'
        db.add_column('candidatures_conformite', 'commentaire',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conformite.commentaire'
        db.delete_column('candidatures_conformite', 'commentaire')
