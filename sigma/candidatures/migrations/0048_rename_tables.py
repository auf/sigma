...
class Migration(DataMigration):
    a_renommer = [
        'appel', 'appel_conformites', 'attributwcs', 'candidat',
        'commentaire', 'conformite', 'diplome', 'dossier',
        'dossier_annotations', 'dossier_experts', 'dossieraccueil',
        'dossiermobilite', 'dossierorigine', 'expert',
        'expert_disciplines', 'note', 'piece', 'typeconformite',
        'typepiece', 'userprofile', 'userprofile_disciplines',
        'userprofile_regions'
    ]

    def forwards(self, orm):
        for table in self.a_renommer:
            db.rename_table('sigma_' + table, 'candidatures_' + table)

    def backwards(self, orm):
        for table in self.a_renommer:
            db.rename_table('candidatures_' + table, 'sigma_' + table)
