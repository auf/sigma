...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sigma_appel', 'code_budgetaire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedcoda.ProjetPoste'], null=True))


    def backwards(self, orm):
        
        # Adding field 'Appel.formulaire_wcs'
        db.add_column('sigma_appel', 'formulaire_wcs', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'Appel.code_budgetaire'
        db.alter_column('sigma_appel', 'code_budgetaire_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['managedcoda.ProjetPoste']))
