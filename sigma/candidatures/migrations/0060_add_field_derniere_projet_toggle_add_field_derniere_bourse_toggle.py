...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dossier.derniere_bourse_toggle'
        db.add_column('candidatures_dossier', 'derniere_bourse_toggle',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Dossier.dernier_projet_toggle'
        db.add_column('candidatures_dossier', 'dernier_projet_toggle',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dossier.derniere_bourse_toggle'
        db.delete_column('candidatures_dossier', 'derniere_bourse_toggle')

        # Deleting field 'Dossier.dernier_projet_toggle'
        db.delete_column('candidatures_dossier', 'dernier_projet_toggle')
