...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Diplome.autre_etablissement_nom'
        db.add_column('sigma_diplome', 'autre_etablissement_nom', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Diplome.etablissement'
        db.add_column('sigma_diplome', 'etablissement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True, blank=True), keep_default=False)

        # Adding field 'Diplome.autre_etablissement_pays'
        db.add_column('sigma_diplome', 'autre_etablissement_pays', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Pays'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Diplome.autre_etablissement_nom'
        db.delete_column('sigma_diplome', 'autre_etablissement_nom')

        # Deleting field 'Diplome.etablissement'
        db.delete_column('sigma_diplome', 'etablissement_id')

        # Deleting field 'Diplome.autre_etablissement_pays'
        db.delete_column('sigma_diplome', 'autre_etablissement_pays_id')
