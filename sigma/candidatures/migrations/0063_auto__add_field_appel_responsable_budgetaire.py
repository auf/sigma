...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appel.responsable_budgetaire'
        db.add_column('candidatures_appel', 'responsable_budgetaire',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Employe'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appel.responsable_budgetaire'
        db.delete_column('candidatures_appel', 'responsable_budgetaire_id')
