...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierMobilite.date_fin'
        db.delete_column('sigma_dossiermobilite', 'date_fin')

        # Deleting field 'DossierMobilite.date_debut'
        db.delete_column('sigma_dossiermobilite', 'date_debut')

        # Deleting field 'DossierMobilite.duree'
        db.delete_column('sigma_dossiermobilite', 'duree')

        # Adding field 'DossierMobilite.date_debut_origine'
        db.add_column('sigma_dossiermobilite', 'date_debut_origine', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.date_fin_origine'
        db.add_column('sigma_dossiermobilite', 'date_fin_origine', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.date_debut_accueil'
        db.add_column('sigma_dossiermobilite', 'date_debut_accueil', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.date_fin_accueil'
        db.add_column('sigma_dossiermobilite', 'date_fin_accueil', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DossierMobilite.date_fin'
        db.add_column('sigma_dossiermobilite', 'date_fin', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.date_debut'
        db.add_column('sigma_dossiermobilite', 'date_debut', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.duree'
        db.add_column('sigma_dossiermobilite', 'duree', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'DossierMobilite.date_debut_origine'
        db.delete_column('sigma_dossiermobilite', 'date_debut_origine')

        # Deleting field 'DossierMobilite.date_fin_origine'
        db.delete_column('sigma_dossiermobilite', 'date_fin_origine')

        # Deleting field 'DossierMobilite.date_debut_accueil'
        db.delete_column('sigma_dossiermobilite', 'date_debut_accueil')

        # Deleting field 'DossierMobilite.date_fin_accueil'
        db.delete_column('sigma_dossiermobilite', 'date_fin_accueil')
