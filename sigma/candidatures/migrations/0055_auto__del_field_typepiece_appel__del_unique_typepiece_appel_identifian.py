...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('candidatures_typepiece', ['appel_id', 'identifiant'])

        # Deleting field 'TypePiece.appel'
        db.delete_column('candidatures_typepiece', 'appel_id')

        # Adding M2M table for field pieces_attendues on 'Appel'
        db.create_table('candidatures_appel_pieces_attendues', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appel', models.ForeignKey(orm['candidatures.appel'], null=False)),
            ('typepiece', models.ForeignKey(orm['candidatures.typepiece'], null=False))
        ))
        db.create_unique('candidatures_appel_pieces_attendues', ['appel_id', 'typepiece_id'])


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TypePiece.appel'
        raise RuntimeError("Cannot reverse this migration. 'TypePiece.appel' and its values cannot be restored.")
        # Adding unique constraint on 'TypePiece', fields ['appel', 'identifiant']
        db.create_unique('candidatures_typepiece', ['appel_id', 'identifiant'])

        # Removing M2M table for field pieces_attendues on 'Appel'
        db.delete_table('candidatures_appel_pieces_attendues')
    ...
    models = {
        ...
        'candidatures.appel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'montant_allocation_unique': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'montant_mensuel_accueil_nord': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'montant_mensuel_accueil_sud': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'montant_mensuel_origine_nord': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'montant_mensuel_origine_sud': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'montant_perdiem_nord': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'montant_perdiem_sud': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'prime_installation_nord': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'prime_installation_sud': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
