...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DossierMobilite.type_intervention'
        db.delete_column('sigma_dossiermobilite', 'type_intervention_id')
        db.add_column('sigma_dossiermobilite', 'type_intervention', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Removing index on 'DossierMobilite', fields ['type_intervention']
        try:
            db.delete_index('sigma_dossiermobilite', ['type_intervention_id'])
        except:
            pass

        # Changing field 'DossierMobilite.public_vise'
        db.delete_column('sigma_dossiermobilite', 'public_vise_id')
        db.add_column('sigma_dossiermobilite', 'public_vise', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Removing index on 'DossierMobilite', fields ['public_vise']
        try:
            db.delete_index('sigma_dossiermobilite', ['public_vise_id'])
        except:
            pass
    ...
    def backwards(self, orm):
        ...
        # Adding index on 'DossierMobilite', fields ['public_vise']
        db.create_index('sigma_dossiermobilite', ['public_vise_id'])

        # Adding index on 'DossierMobilite', fields ['type_intervention']
        db.create_index('sigma_dossiermobilite', ['type_intervention_id'])
        ...
        # Renaming column for 'DossierMobilite.type_intervention' to match new field type.
        db.rename_column('sigma_dossiermobilite', 'type_intervention', 'type_intervention_id')
        # Changing field 'DossierMobilite.type_intervention'
        db.alter_column('sigma_dossiermobilite', 'type_intervention_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sigma.Intervention'], null=True))

        # Renaming column for 'DossierMobilite.public_vise' to match new field type.
        db.rename_column('sigma_dossiermobilite', 'public_vise', 'public_vise_id')
        # Changing field 'DossierMobilite.public_vise'
        db.alter_column('sigma_dossiermobilite', 'public_vise_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sigma.Public'], null=True))
    ...
    models = {
        ...
        'sigma.appel': {
            ...
            'code_budgetaire': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['managedcoda.ProjetPoste']", 'null': 'True', 'blank': 'True'}),
        ...
        'sigma.typepiece': {
            ...
            'appel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pieces_attendues'", 'to': "orm['sigma.Appel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
