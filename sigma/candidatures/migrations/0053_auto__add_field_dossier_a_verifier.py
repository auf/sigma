...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dossier.a_verifier'
        db.add_column('candidatures_dossier', 'a_verifier',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dossier.a_verifier'
        db.delete_column('candidatures_dossier', 'a_verifier')
