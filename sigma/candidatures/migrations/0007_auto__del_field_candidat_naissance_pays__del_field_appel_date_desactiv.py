...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Candidat.naissance_pays'
        db.delete_column('sigma_candidat', 'naissance_pays_id')
        ...
        # Adding field 'Appel.montant_allocation_unique'
        db.add_column('sigma_appel', 'montant_allocation_unique', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.montant_mensuel_accueil_nord'
        db.add_column('sigma_appel', 'montant_mensuel_accueil_nord', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.montant_mensuel_accueil_sud'
        db.add_column('sigma_appel', 'montant_mensuel_accueil_sud', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.periode'
        db.add_column('sigma_appel', 'periode', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Appel.bareme'
        db.add_column('sigma_appel', 'bareme', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Appel.montant_mensuel_origine_nord'
        db.add_column('sigma_appel', 'montant_mensuel_origine_nord', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.montant_mensuel_origine_sud'
        db.add_column('sigma_appel', 'montant_mensuel_origine_sud', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.montant_perdiem_nord'
        db.add_column('sigma_appel', 'montant_perdiem_nord', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.appel_en_ligne'
        db.add_column('sigma_appel', 'appel_en_ligne', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Appel.montant_prime_installation'
        db.add_column('sigma_appel', 'montant_prime_installation', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.montant_perdiem_sud'
        db.add_column('sigma_appel', 'montant_perdiem_sud', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'Appel.code_budgetaire'
        db.alter_column('sigma_appel', 'code_budgetaire', self.gf('django.db.models.fields.CharField')(max_length=255))
    
    
    def backwards(self, orm):
        
        # Adding field 'Candidat.naissance_pays'
        db.add_column('sigma_candidat', 'naissance_pays', self.gf('django.db.models.fields.related.ForeignKey')(related_name='naissance_pays', null=True, to=orm['datamaster_modeles.Pays'], blank=True), keep_default=False)
        ...
        # Deleting field 'Appel.montant_allocation_unique'
        db.delete_column('sigma_appel', 'montant_allocation_unique')

        # Deleting field 'Appel.montant_mensuel_accueil_nord'
        db.delete_column('sigma_appel', 'montant_mensuel_accueil_nord')

        # Deleting field 'Appel.montant_mensuel_accueil_sud'
        db.delete_column('sigma_appel', 'montant_mensuel_accueil_sud')

        # Deleting field 'Appel.periode'
        db.delete_column('sigma_appel', 'periode')

        # Deleting field 'Appel.bareme'
        db.delete_column('sigma_appel', 'bareme')

        # Deleting field 'Appel.montant_mensuel_origine_nord'
        db.delete_column('sigma_appel', 'montant_mensuel_origine_nord')

        # Deleting field 'Appel.montant_mensuel_origine_sud'
        db.delete_column('sigma_appel', 'montant_mensuel_origine_sud')

        # Deleting field 'Appel.montant_perdiem_nord'
        db.delete_column('sigma_appel', 'montant_perdiem_nord')

        # Deleting field 'Appel.appel_en_ligne'
        db.delete_column('sigma_appel', 'appel_en_ligne')

        # Deleting field 'Appel.montant_prime_installation'
        db.delete_column('sigma_appel', 'montant_prime_installation')

        # Deleting field 'Appel.montant_perdiem_sud'
        db.delete_column('sigma_appel', 'montant_perdiem_sud')

        # Changing field 'Appel.code_budgetaire'
        db.alter_column('sigma_appel', 'code_budgetaire', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))
