...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sigma_dossiermobilite', 'intitule_projet', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'DossierMobilite.intitule_projet'
        db.alter_column('sigma_dossiermobilite', 'intitule_projet', self.gf('django.db.models.fields.CharField')(max_length=255))
