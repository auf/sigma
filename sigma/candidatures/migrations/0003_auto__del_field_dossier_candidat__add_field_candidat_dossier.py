...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Dossier.candidat'
        db.delete_column('sigma_dossier', 'candidat_id')

        # Adding field 'Candidat.dossier'
        db.add_column('sigma_candidat', 'dossier', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='candidat', to=orm['sigma.Dossier']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Dossier.candidat'
        db.add_column('sigma_dossier', 'candidat', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='candidat', to=orm['sigma.Candidat']), keep_default=False)

        # Deleting field 'Candidat.dossier'
        db.delete_column('sigma_candidat', 'dossier_id')
    ...
    models = {
        ...
        'sigma.candidat': {
            ...
            'dossier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'candidat'", 'to': "orm['sigma.Dossier']"}),
