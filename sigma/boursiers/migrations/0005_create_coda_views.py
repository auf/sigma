...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("CREATE VIEW coda_element AS SELECT * FROM datamaster.coda_element")
        db.execute("CREATE VIEW coda_ecriture AS SELECT * FROM datamaster.coda_ecriture")
        db.execute("""CREATE VIEW coda_ligne_ecriture AS 
                      SELECT * FROM datamaster.coda_ligne_ecriture
                      WHERE tiers_operation_id LIKE '2.__________L' OR
                            tiers_operation_id LIKE '2._________L'""")
    
    
    def backwards(self, orm):
        db.execute("DROP VIEW coda_element")
        db.execute("DROP VIEW coda_ecriture")
        db.execute("DROP VIEW coda_ligne_ecriture")
