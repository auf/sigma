...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DepensePrevisionnelle.allocation'
        db.add_column('boursiers_depenseprevisionnelle', 'allocation',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='depenses_previsionnelles', null=True, to=orm['boursiers.Allocation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DepensePrevisionnelle.allocation'
        db.delete_column('boursiers_depenseprevisionnelle', 'allocation_id')
    ...
    models = {
        ...
        'boursiers.allocation': {
            ...
            'allocataire': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'allocataires'", 'to': "orm['boursiers.Allocataire']"}),
