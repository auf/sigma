...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Allocataire.nationalite'
        db.add_column('boursiers_allocataire', 'nationalite',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Pays'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Allocataire.pays'
        db.add_column('boursiers_allocataire', 'pays',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='allocataires', null=True, to=orm['references.Pays']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Allocataire.nationalite'
        db.delete_column('boursiers_allocataire', 'nationalite_id')

        # Deleting field 'Allocataire.pays'
        db.delete_column('boursiers_allocataire', 'pays_id')
