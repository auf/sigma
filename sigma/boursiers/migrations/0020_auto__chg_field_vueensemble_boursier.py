...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VueEnsemble.boursier'
        db.alter_column('boursiers_vueensemble', 'boursier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['boursiers.Boursier']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VueEnsemble.boursier'
        raise RuntimeError("Cannot reverse this migration. 'VueEnsemble.boursier' and its values cannot be restored.")
    ...
    models = {
        ...
        'boursiers.vueensemble': {
            ...
            'boursier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vue_ensemble'", 'null': 'True', 'to': "orm['boursiers.Boursier']"}),
