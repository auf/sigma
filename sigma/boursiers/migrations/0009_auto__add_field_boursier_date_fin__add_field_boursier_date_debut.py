...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Boursier.date_fin'
        db.add_column('suivi_boursier', 'date_fin', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Boursier.date_debut'
        db.add_column('suivi_boursier', 'date_debut', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Boursier.date_fin'
        db.delete_column('suivi_boursier', 'date_fin')

        # Deleting field 'Boursier.date_debut'
        db.delete_column('suivi_boursier', 'date_debut')
