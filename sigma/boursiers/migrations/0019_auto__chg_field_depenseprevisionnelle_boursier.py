...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DepensePrevisionnelle.boursier'
        db.alter_column('boursiers_depenseprevisionnelle', 'boursier_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['boursiers.Boursier']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DepensePrevisionnelle.boursier'
        raise RuntimeError("Cannot reverse this migration. 'DepensePrevisionnelle.boursier' and its values cannot be restored.")
    ...
    models = {
        ...
        'boursiers.depenseprevisionnelle': {
            ...
            'boursier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'depenses_previsionnelles'", 'null': 'True', 'to': "orm['boursiers.Boursier']"}),
