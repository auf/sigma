...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VueEnsemble'
        db.create_table('boursiers_vueensemble', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vue_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('code_document', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('code_sigma', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('boursier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vue_ensemble', to=orm['boursiers.Boursier'])),
        ))
        db.send_create_signal('boursiers', ['VueEnsemble'])

        # Adding field 'DepensePrevisionnelle.commentaires'
        db.add_column('boursiers_depenseprevisionnelle', 'commentaires',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DepensePrevisionnelle.mois'
        db.add_column('boursiers_depenseprevisionnelle', 'mois',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'DepensePrevisionnelle.date'
        db.alter_column('boursiers_depenseprevisionnelle', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting model 'VueEnsemble'
        db.delete_table('boursiers_vueensemble')

        # Deleting field 'DepensePrevisionnelle.commentaires'
        db.delete_column('boursiers_depenseprevisionnelle', 'commentaires')

        # Deleting field 'DepensePrevisionnelle.mois'
        db.delete_column('boursiers_depenseprevisionnelle', 'mois')


        # Changing field 'DepensePrevisionnelle.date'
        db.alter_column('boursiers_depenseprevisionnelle', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 14, 0, 0)))
    ...
    models = {
        ...
        'boursiers.depenseprevisionnelle': {
            ...
            'mois': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'boursiers.vueensemble': {
            ...
            'boursier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vue_ensemble'", 'to': "orm['boursiers.Boursier']"}),
