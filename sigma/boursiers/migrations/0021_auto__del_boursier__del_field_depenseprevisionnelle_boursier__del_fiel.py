...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('boursiers_boursier')

        # Deleting field 'DepensePrevisionnelle.boursier'
        db.delete_column('boursiers_depenseprevisionnelle', 'boursier_id')

        # Deleting field 'VueEnsemble.boursier'
        db.delete_column('boursiers_vueensemble', 'boursier_id')


    def backwards(self, orm):
        # Adding model 'Boursier'
        db.create_table('boursiers_boursier', (
            ('dossier', self.gf('django.db.models.fields.related.OneToOneField')(related_name='boursier', unique=True, primary_key=True, to=orm['candidatures.Dossier'])),
            ...
            ('code_operation', self.gf('django.db.models.fields.CharField')(blank=True, max_length=11, db_index=True)),
        ))
        db.send_create_signal('boursiers', ['Boursier'])

        # Adding field 'DepensePrevisionnelle.boursier'
        db.add_column('boursiers_depenseprevisionnelle', 'boursier',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='depenses_previsionnelles', null=True, to=orm['boursiers.Boursier']),
                      keep_default=False)

        # Adding field 'VueEnsemble.boursier'
        db.add_column('boursiers_vueensemble', 'boursier',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='vue_ensemble', null=True, to=orm['boursiers.Boursier']),
                      keep_default=False)
