...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Allocation.date_demande_police_assurance'
        db.add_column('boursiers_allocation', 'date_demande_police_assurance',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Allocation.date_debut_assurance'
        db.add_column('boursiers_allocation', 'date_debut_assurance',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Allocation.date_fin_assurance'
        db.add_column('boursiers_allocation', 'date_fin_assurance',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Allocation.type_assurance'
        db.add_column('boursiers_allocation', 'type_assurance',
                      self.gf('django.db.models.fields.CharField')(default='IN', max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Allocation.date_demande_police_assurance'
        db.delete_column('boursiers_allocation', 'date_demande_police_assurance')

        # Deleting field 'Allocation.date_debut_assurance'
        db.delete_column('boursiers_allocation', 'date_debut_assurance')

        # Deleting field 'Allocation.date_fin_assurance'
        db.delete_column('boursiers_allocation', 'date_fin_assurance')

        # Deleting field 'Allocation.type_assurance'
        db.delete_column('boursiers_allocation', 'type_assurance')
    ...
    models = {
        ...
        'boursiers.allocation': {
            ...
            'date_debut_assurance': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_demande_police_assurance': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_fin': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_fin_assurance': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'type_assurance': ('django.db.models.fields.CharField', [], {'default': "'IN'", 'max_length': '2', 'null': 'True', 'blank': 'True'})
        },
