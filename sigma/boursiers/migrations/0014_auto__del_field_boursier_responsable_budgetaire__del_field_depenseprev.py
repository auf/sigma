...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Boursier.responsable_budgetaire'
        db.delete_column('boursiers_boursier', 'responsable_budgetaire_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('boursiers_boursier', 'responsable_budgetaire',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Employe'], null=True, blank=True),
                      keep_default=False)
