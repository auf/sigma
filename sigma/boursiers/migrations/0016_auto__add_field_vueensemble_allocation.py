...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VueEnsemble.allocation'
        db.add_column('boursiers_vueensemble', 'allocation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='vue_ensemble', to=orm['boursiers.Allocation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VueEnsemble.allocation'
        db.delete_column('boursiers_vueensemble', 'allocation_id')
