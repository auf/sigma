...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('boursiers_allocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dossier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='allocations', to=orm['candidatures.Dossier'])),
            ('allocataire', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boursiers.Allocataire'])),
            ('allocation_originale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boursiers.Allocation'], null=True, blank=True)),
            ('code_operation', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=11, blank=True)),
            ('numero_police_assurance', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
        ...
        db.send_create_signal('boursiers', ['Allocation'])

        # Adding model 'AllocationMobilite'
        db.create_table('boursiers_allocationmobilite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_debut_origine', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_fin_origine', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_debut_accueil', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('date_fin_accueil', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('intitule_projet', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('mots_clefs', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('discipline', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Discipline'], null=True, blank=True)),
            ('sous_discipline', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('formation_en_cours_diplome', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('formation_en_cours_niveau', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('diplome_demande_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('diplome_demande_niveau', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('these_date_inscription', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('these_soutenance_pays', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Pays'], null=True, blank=True)),
            ('these_soutenance_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('these_type', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('type_intervention', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('public_vise', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('autres_publics', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('cofinancement', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('cofinancement_source', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cofinancement_montant', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=2, blank=True)),
            ('allocation', self.gf('django.db.models.fields.related.OneToOneField')(related_name='mobilite', unique=True, to=orm['boursiers.Allocation'])),
        ))
        db.send_create_signal('boursiers', ['AllocationMobilite'])

        # Adding model 'Allocataire'
        db.create_table('boursiers_allocataire', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('telephone_portable', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('courriel', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True)),
            ...
            ('adresse_complement', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('code_postal', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('boursiers', ['Allocataire'])

        # Adding model 'AllocationOrigine'
        db.create_table('boursiers_allocationorigine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('etablissement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Etablissement'], null=True, blank=True)),
            ('autre_etablissement_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('autre_etablissement_pays', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Pays'], null=True, blank=True)),
            ('autre_etablissement_adresse', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('autre_etablissement_code_postal', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('autre_etablissement_ville', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('autre_etablissement_region', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_sc_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('resp_sc_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_sc_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_sc_fonction', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_sc_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_sc_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_sc_fax', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('faculte_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('faculte_adresse', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('faculte_ville', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('faculte_code_postal', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dir_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('dir_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dir_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dir_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dir_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_inst_civilite', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True)),
            ('resp_inst_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_inst_prenom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_inst_fonction', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_inst_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_inst_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('resp_inst_fax', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('allocation', self.gf('django.db.models.fields.related.OneToOneField')(related_name='origine', unique=True, to=orm['boursiers.Allocation'])),
        ))
        db.send_create_signal('boursiers', ['AllocationOrigine'])

        # Adding model 'AllocationAccueil'
        db.create_table('boursiers_allocationaccueil', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('etablissement', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Etablissement'], null=True, blank=True)),
            ('autre_etablissement_nom', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('autre_etablissement_pays', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['references.Pays'], null=True, blank=True)),
            ...
            ('dir_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('dir_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('allocation', self.gf('django.db.models.fields.related.OneToOneField')(related_name='accueil', unique=True, to=orm['boursiers.Allocation'])),
        ))
        db.send_create_signal('boursiers', ['AllocationAccueil'])


    def backwards(self, orm):
        # Deleting model 'Allocation'
        db.delete_table('boursiers_allocation')

        # Deleting model 'AllocationMobilite'
        db.delete_table('boursiers_allocationmobilite')

        # Deleting model 'Allocataire'
        db.delete_table('boursiers_allocataire')

        # Deleting model 'AllocationOrigine'
        db.delete_table('boursiers_allocationorigine')

        # Deleting model 'AllocationAccueil'
        db.delete_table('boursiers_allocationaccueil')
    ...
    models = {
        ...
        'boursiers.allocation': {
            ...
            'allocataire': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['boursiers.Allocataire']"}),
