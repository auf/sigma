    ...
    def __init__(self, **kwargs):
        ...
        self.children += [
            ...
            MenuItem('Sigma', children=[
                MenuItem('Appels', reverse('admin:sigma_appel_changelist')),
                MenuItem(
                    'Dossiers', reverse('admin:sigma_dossier_changelist')
                ),
                MenuItem(
                    'Boursiers', reverse('admin:suivi_boursier_changelist')
                ),
                MenuItem('Experts', reverse('admin:sigma_expert_changelist')),
                MenuItem('Formulaire WCS', reverse('formulaire_wcs')),
            ])
        ]
