...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Boursier'
        db.create_table('suivi_boursier', (
            ('dossier', self.gf('django.db.models.fields.related.OneToOneField')(related_name='boursier', unique=True, primary_key=True, to=orm['sigma.Dossier'])),
        ))
        db.send_create_signal('suivi', ['Boursier'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Boursier'
        db.delete_table('suivi_boursier')
