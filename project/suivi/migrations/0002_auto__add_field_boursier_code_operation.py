...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Boursier.code_operation'
        db.add_column('suivi_boursier', 'code_operation', self.gf('django.db.models.fields.CharField')(default='', max_length=11), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Boursier.code_operation'
        db.delete_column('suivi_boursier', 'code_operation')
    ...
    models = {
        ...
        'suivi.boursier': {
            ...
            'code_operation': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '11'}),
