...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing field 'Boursier.responsable_budgetaire'
        db.delete_column('suivi_boursier', 'responsable_budgetaire')

        # Adding field 'Boursier.responsable_budgetaire'
        db.add_column('suivi_boursier', 'responsable_budgetaire', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Employe'], null=True, blank=True))

        # Adding index on 'Boursier', fields ['responsable_budgetaire']
        db.create_index('suivi_boursier', ['responsable_budgetaire_id'])
    
    
    def backwards(self, orm):
        
        # Removing field 'Boursier.responsable_budgetaire'
        db.delete_column('suivi_boursier', 'responsable_budgetaire_id')

        # Adding field 'Boursier.responsable_budgetaire'
        db.add_column('suivi_boursier', 'responsable_budgetaire', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
    ...
    models = {
        ...
        'datamaster_modeles.employe': {
            'Meta': {'object_name': 'Employe', 'db_table': "u'ref_employe'"},
            'actif': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'poste_type_1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'poste_type_1'", 'null': 'True', 'db_column': "'poste_type_1'", 'to': "orm['datamaster_modeles.PosteType']"}),
            'poste_type_2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'poste_type_2'", 'null': 'True', 'db_column': "'poste_type_2'", 'to': "orm['datamaster_modeles.PosteType']"}),
            'prenom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'responsable': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'responsable_de'", 'null': 'True', 'db_column': "'responsable'", 'to': "orm['datamaster_modeles.Employe']"}),
        ...
        'suivi.boursier': {
            ...
            'code_operation': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '11', 'db_index': 'True', 'blank': 'True'}),
            ...
            'responsable_budgetaire': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['datamaster_modeles.Employe']", 'null': 'True', 'blank': 'True'})
        },
