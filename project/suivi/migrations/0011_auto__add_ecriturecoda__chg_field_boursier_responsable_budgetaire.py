...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EcritureCODA'
        db.create_table('suivi_ecriturecoda', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('boursier_id', self.gf('django.db.models.fields.CharField')(max_length=11, db_index=True)),
            ('code_document', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('numero_document', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('periode', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('date_document', self.gf('django.db.models.fields.DateField')()),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('numero_pcg', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('nom_pcg', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('montant', self.gf('django.db.models.fields.DecimalField')(max_digits=17, decimal_places=2)),
            ('implantation_payeuse', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ...
            ('date_maj', self.gf('django.db.models.fields.DateField')(db_index=True)),
        ))
        db.send_create_signal('suivi', ['EcritureCODA'])


        # Changing field 'Boursier.responsable_budgetaire'
        db.alter_column('suivi_boursier', 'responsable_budgetaire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Employe'], null=True))

    def backwards(self, orm):
        # Deleting model 'EcritureCODA'
        db.delete_table('suivi_ecriturecoda')


        # Changing field 'Boursier.responsable_budgetaire'
        db.alter_column('suivi_boursier', 'responsable_budgetaire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Employe'], null=True))
    ...
    models = {
        ...
        'suivi.boursier': {
            ...
            'responsable_budgetaire': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['managedref.Employe']", 'null': 'True', 'blank': 'True'})
        },
        'suivi.depenseprevisionnelle': {
            'Meta': {'object_name': 'DepensePrevisionnelle'},
            'boursier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'depenses_previsionnelles'", 'to': "orm['suivi.Boursier']"}),
