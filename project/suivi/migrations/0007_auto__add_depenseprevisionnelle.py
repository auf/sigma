...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DepensePrevisionnelle'
        db.create_table('suivi_depenseprevisionnelle', (
            ('description', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('implantation', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ...
            ('boursier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['suivi.Boursier'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('suivi', ['DepensePrevisionnelle'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'DepensePrevisionnelle'
        db.delete_table('suivi_depenseprevisionnelle')
    ...
    models = {
        ...
        'suivi.depenseprevisionnelle': {
            ...
            'boursier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['suivi.Boursier']"}),
