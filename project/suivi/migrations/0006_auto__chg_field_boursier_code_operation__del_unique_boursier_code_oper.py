...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('suivi_boursier', 'code_operation', self.gf('django.db.models.fields.CharField')(max_length=11, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Boursier.code_operation'
        db.alter_column('suivi_boursier', 'code_operation', self.gf('django.db.models.fields.CharField')(blank=True, unique=True, max_length=11, null=True))
