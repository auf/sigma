...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('suivi_boursier', 'responsable_budgetaire', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    models = {
        ...
        'suivi.boursier': {
            ...
            'responsable_budgetaire': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'})
        },
        'suivi.depenseprevisionnelle': {
            'Meta': {'object_name': 'DepensePrevisionnelle'},
            'boursier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'depensesprevisionnelles'", 'to': "orm['suivi.Boursier']"}),
