...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Boursier.numero_police_assurance'
        db.add_column('suivi_boursier', 'numero_police_assurance', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Boursier.numero_police_assurance'
        db.delete_column('suivi_boursier', 'numero_police_assurance')
