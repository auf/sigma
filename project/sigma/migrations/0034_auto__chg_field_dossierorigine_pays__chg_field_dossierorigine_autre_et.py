...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DossierOrigine.pays'
        db.alter_column('sigma_dossierorigine', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field='code', null=True, to=orm['managedref.Pays']))

        # Changing field 'DossierOrigine.autre_etablissement_pays'
        db.alter_column('sigma_dossierorigine', 'autre_etablissement_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Pays'], null=True))
        ...
        db.alter_column('sigma_expert', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Region']))

        # Changing field 'Expert.etablissement'
        db.alter_column('sigma_expert', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Etablissement'], null=True))

        # Changing field 'Dossier.discipline'
        db.alter_column('sigma_dossier', 'discipline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Discipline'], null=True))

        # Changing field 'Dossier.bureau_rattachement'
        db.alter_column('sigma_dossier', 'bureau_rattachement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Bureau'], null=True))

        # Changing field 'GroupeRegional.region'
        db.alter_column('sigma_grouperegional', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Region']))

        # Changing field 'Diplome.etablissement'
        db.alter_column('sigma_diplome', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Etablissement'], null=True))

        # Changing field 'Diplome.autre_etablissement_pays'
        db.alter_column('sigma_diplome', 'autre_etablissement_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['managedref.Pays']))

        # Changing field 'DossierMobilite.discipline'
        db.alter_column('sigma_dossiermobilite', 'discipline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Discipline'], null=True))

        # Changing field 'DossierMobilite.these_soutenance_pays'
        db.alter_column('sigma_dossiermobilite', 'these_soutenance_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['managedref.Pays']))

        # Changing field 'Candidat.pays'
        db.alter_column('sigma_candidat', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['managedref.Pays']))

        # Changing field 'Candidat.nationalite'
        db.alter_column('sigma_candidat', 'nationalite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Pays'], null=True))

        # Changing field 'DossierAccueil.pays'
        db.alter_column('sigma_dossieraccueil', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field='code', null=True, to=orm['managedref.Pays']))

        # Changing field 'DossierAccueil.autre_etablissement_pays'
        db.alter_column('sigma_dossieraccueil', 'autre_etablissement_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Pays'], null=True))
        ...
        # Changing field 'Appel.code_budgetaire'
        db.alter_column('sigma_appel', 'code_budgetaire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedcoda.ProjetPoste']))

        # Changing field 'Appel.region'
        if not db.dry_run:
            for appel in orm['sigma.Appel'].objects.all():
                appel.code_budgetaire_id = appel.code_budgetaire_id[2:]
                appel.save()
        db.alter_column('sigma_appel', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['managedref.Region']))


    def backwards(self, orm):
        
        # Changing field 'DossierOrigine.pays'
        db.alter_column('sigma_dossierorigine', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field='code', null=True, to=orm['datamaster_modeles.Pays']))

        # Changing field 'DossierOrigine.autre_etablissement_pays'
        db.alter_column('sigma_dossierorigine', 'autre_etablissement_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Pays'], null=True))

        # Changing field 'DossierOrigine.etablissement'
        db.alter_column('sigma_dossierorigine', 'etablissement_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True))
        ...
        # Changing field 'Expert.etablissement'
        db.alter_column('sigma_expert', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True))

        # Changing field 'Dossier.discipline'
        db.alter_column('sigma_dossier', 'discipline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Discipline'], null=True))

        # Changing field 'Dossier.bureau_rattachement'
        db.alter_column('sigma_dossier', 'bureau_rattachement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Bureau'], null=True))

        # Changing field 'GroupeRegional.region'
        db.alter_column('sigma_grouperegional', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Region']))

        # Changing field 'Diplome.etablissement'
        db.alter_column('sigma_diplome', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True))

        # Changing field 'Diplome.autre_etablissement_pays'
        db.alter_column('sigma_diplome', 'autre_etablissement_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datamaster_modeles.Pays']))

        # Changing field 'DossierMobilite.discipline'
        db.alter_column('sigma_dossiermobilite', 'discipline_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Discipline'], null=True))

        # Changing field 'DossierMobilite.these_soutenance_pays'
        db.alter_column('sigma_dossiermobilite', 'these_soutenance_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datamaster_modeles.Pays']))

        # Changing field 'Candidat.pays'
        db.alter_column('sigma_candidat', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datamaster_modeles.Pays']))

        # Changing field 'Candidat.nationalite'
        db.alter_column('sigma_candidat', 'nationalite_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Pays'], null=True))

        # Changing field 'DossierAccueil.pays'
        db.alter_column('sigma_dossieraccueil', 'pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to_field='code', null=True, to=orm['datamaster_modeles.Pays']))

        # Changing field 'DossierAccueil.autre_etablissement_pays'
        db.alter_column('sigma_dossieraccueil', 'autre_etablissement_pays_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Pays'], null=True))

        # Changing field 'DossierAccueil.etablissement'
        db.alter_column('sigma_dossieraccueil', 'etablissement_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['datamaster_modeles.Etablissement'], null=True))

        # Changing field 'Appel.code_budgetaire'
        db.alter_column('sigma_appel', 'code_budgetaire_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coda.Element']))

        # Changing field 'Appel.region'
        db.alter_column('sigma_appel', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datamaster_modeles.Region']))
        if not db.dry_run:
            for appel in orm['sigma.Appel'].objects.all():
                appel.code_budgetaire_id = '3.' + appel.code_budgetaire_id
                appel.save()
    ...
    models = {
        ...
        'sigma.appel': {
            ...
            'conformites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sigma.TypeConformite']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            ...
            'types_piece': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sigma.TypePiece']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'})
        },
        'sigma.attributwcs': {
        ...
        'sigma.candidat': {
            ...
            'pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pays'", 'blank': 'True', 'null': 'True', 'to': "orm['managedref.Pays']"}),
        ...
        'sigma.diplome': {
            ...
            'autre_etablissement_pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'etablissement_pays'", 'blank': 'True', 'null': 'True', 'to': "orm['managedref.Pays']"}),
        ...
        'sigma.dossieraccueil': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'accueil_pays'", 'to_field': "'code'", 'blank': 'True', 'null': 'True', 'to': "orm['managedref.Pays']"}),
        ...
        'sigma.dossiermobilite': {
            ...
            'these_soutenance_pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'soutenance_pays'", 'blank': 'True', 'null': 'True', 'to': "orm['managedref.Pays']"}),
        ...
        'sigma.dossierorigine': {
            ...
            'faculte_ville': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pays': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'origine_pays'", 'to_field': "'code'", 'blank': 'True', 'null': 'True', 'to': "orm['managedref.Pays']"}),
        ...
        'sigma.expert': {
            ...
            'disciplines': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['managedref.Discipline']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            'etablissement': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['managedref.Etablissement']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'prenom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
