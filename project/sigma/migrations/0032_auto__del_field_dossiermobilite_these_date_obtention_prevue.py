...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierMobilite.these_date_obtention_prevue'
        db.delete_column('sigma_dossiermobilite', 'these_date_obtention_prevue')
    
    
    def backwards(self, orm):
        
        # Adding field 'DossierMobilite.these_date_obtention_prevue'
        db.add_column('sigma_dossiermobilite', 'these_date_obtention_prevue', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
