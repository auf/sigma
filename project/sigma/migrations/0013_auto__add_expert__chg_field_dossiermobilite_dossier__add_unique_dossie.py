...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DossierMobilite.dossier'
        db.alter_column('sigma_dossiermobilite', 'dossier_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['sigma.Dossier']))

        # Adding unique constraint on 'DossierMobilite', fields ['dossier']
        db.create_unique('sigma_dossiermobilite', ['dossier_id'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DossierMobilite.dossier'
        db.alter_column('sigma_dossiermobilite', 'dossier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sigma.Dossier']))

        # Removing unique constraint on 'DossierMobilite', fields ['dossier']
        db.delete_unique('sigma_dossiermobilite', ['dossier_id'])
    ...
    models = {
        ...
        'sigma.dossier': {
            ...
            'notes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sigma.Note']", 'null': 'True', 'blank': 'True'}),
