...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appel.region'
        db.add_column('sigma_appel', 'region', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['datamaster_modeles.Region']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Appel.region'
        db.delete_column('sigma_appel', 'region_id')
    ...
    models = {
        ...
        'sigma.grouperegional': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['datamaster_modeles.Region']"}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'})
        },
        'sigma.intervention': {
