...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('sigma_appel', 'etat')
    
    
    def backwards(self, orm):
        
        # Adding field 'Appel.etat'
        db.add_column('sigma_appel', 'etat', self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True, blank=True), keep_default=False)
