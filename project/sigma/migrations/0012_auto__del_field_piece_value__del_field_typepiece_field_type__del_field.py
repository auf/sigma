...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field commentaires on 'Dossier'
        db.delete_table('sigma_dossier_commentaires')
        ...
        # Removing M2M table for field pieces on 'Appel'
        db.delete_table('sigma_appel_pieces')

        # Deleting field 'TypePiece.field_type'
        db.delete_column('sigma_typepiece', 'field_type')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field commentaires on 'Dossier'
        db.create_table('sigma_dossier_commentaires', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dossier', models.ForeignKey(orm['sigma.dossier'], null=False)),
            ('commentaire', models.ForeignKey(orm['sigma.commentaire'], null=False))
        ))
        db.create_unique('sigma_dossier_commentaires', ['dossier_id', 'commentaire_id'])
        ...
        # Adding M2M table for field pieces on 'Appel'
        db.create_table('sigma_appel_pieces', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appel', models.ForeignKey(orm['sigma.appel'], null=False)),
            ('typepiece', models.ForeignKey(orm['sigma.typepiece'], null=False))
        ))
        db.create_unique('sigma_appel_pieces', ['appel_id', 'typepiece_id'])

        # Adding field 'TypePiece.field_type'
        db.add_column('sigma_typepiece', 'field_type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'TypePiece.name'
        db.add_column('sigma_typepiece', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
