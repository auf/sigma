...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Candidat.adresse_complement'
        db.add_column('sigma_candidat', 'adresse_complement', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Candidat.adresse_complement'
        db.delete_column('sigma_candidat', 'adresse_complement')
