...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Appel.prime_installation_sud'
        db.add_column('sigma_appel', 'prime_installation_sud', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Appel.prime_installation_nord'
        db.add_column('sigma_appel', 'prime_installation_nord', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Appel.prime_installation_sud'
        db.delete_column('sigma_appel', 'prime_installation_sud')

        # Deleting field 'Appel.prime_installation_nord'
        db.delete_column('sigma_appel', 'prime_installation_nord')
