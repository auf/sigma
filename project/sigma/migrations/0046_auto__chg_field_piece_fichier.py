...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Piece.fichier'
        db.alter_column('sigma_piece', 'fichier', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Piece.fichier'
        db.alter_column('sigma_piece', 'fichier', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
