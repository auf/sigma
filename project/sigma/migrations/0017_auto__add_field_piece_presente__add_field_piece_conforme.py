...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Piece.presente'
        db.add_column('sigma_piece', 'presente', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Piece.conforme'
        db.add_column('sigma_piece', 'conforme', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Piece.presente'
        db.delete_column('sigma_piece', 'presente')

        # Deleting field 'Piece.conforme'
        db.delete_column('sigma_piece', 'conforme')
    ...
    models = {
        ...
        'sigma.piece': {
            ...
            'conforme': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'presente': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        'sigma.public': {
