...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sigma_candidat', 'adresse_complement', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Candidat.adresse'
        db.alter_column('sigma_candidat', 'adresse', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Candidat.adresse_complement'
        db.alter_column('sigma_candidat', 'adresse_complement', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Candidat.adresse'
        db.alter_column('sigma_candidat', 'adresse', self.gf('django.db.models.fields.CharField')(max_length=255))
