...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dossier.moyenne_votes'
        db.add_column('sigma_dossier', 'moyenne_votes', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Dossier.moyenne_votes'
        db.delete_column('sigma_dossier', 'moyenne_votes')
