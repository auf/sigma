...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierMobilite.alternance_accueil_puis_origine'
        db.delete_column('sigma_dossiermobilite', 'alternance_accueil_puis_origine')

        # Deleting field 'DossierMobilite.alternance_nb_mois_accueil'
        db.delete_column('sigma_dossiermobilite', 'alternance_nb_mois_accueil')

        # Deleting field 'DossierMobilite.alternance_nb_mois_origine'
        db.delete_column('sigma_dossiermobilite', 'alternance_nb_mois_origine')


    def backwards(self, orm):
        
        # Adding field 'DossierMobilite.alternance_accueil_puis_origine'
        db.add_column('sigma_dossiermobilite', 'alternance_accueil_puis_origine', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.alternance_nb_mois_accueil'
        db.add_column('sigma_dossiermobilite', 'alternance_nb_mois_accueil', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierMobilite.alternance_nb_mois_origine'
        db.add_column('sigma_dossiermobilite', 'alternance_nb_mois_origine', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
