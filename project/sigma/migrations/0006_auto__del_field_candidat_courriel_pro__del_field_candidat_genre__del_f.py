...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Candidat.fax_pro'
        db.delete_column('sigma_candidat', 'fax_pro')

        # Deleting field 'Candidat.fax_perso'
        db.delete_column('sigma_candidat', 'fax_perso')
    
    
    def backwards(self, orm):
        
        # Adding field 'Candidat.courriel_pro'
        db.add_column('sigma_candidat', 'courriel_pro', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Candidat.fax_pro'
        db.add_column('sigma_candidat', 'fax_pro', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Candidat.fax_perso'
        db.add_column('sigma_candidat', 'fax_perso', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
