...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for diplome in orm.Diplome.objects.all():
            diplome.autre_etablissement_nom = diplome.etablissement_nom
            diplome.autre_etablissement_pays = diplome.etablissement_pays
            diplome.save()

    
    def backwards(self, orm):
        for diplome in orm.Diplome.objects.all():
            diplome.etablissement_nom = diplome.autre_etablissement_nom
            diplome.etablissement_pays = diplome.autre_etablissement_pays
            diplome.save()
