...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierOrigine.autre_etablissement_erreur'
        db.delete_column('sigma_dossierorigine', 'autre_etablissement_erreur')

        # Deleting field 'DossierOrigine.autre_etablissement_valide'
        db.delete_column('sigma_dossierorigine', 'autre_etablissement_valide')

        # Deleting field 'DossierAccueil.autre_etablissement_erreur'
        db.delete_column('sigma_dossieraccueil', 'autre_etablissement_erreur')

        # Deleting field 'DossierAccueil.autre_etablissement_valide'
        db.delete_column('sigma_dossieraccueil', 'autre_etablissement_valide')
    
    
    def backwards(self, orm):
        
        # Adding field 'DossierOrigine.autre_etablissement_erreur'
        db.add_column('sigma_dossierorigine', 'autre_etablissement_erreur', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.autre_etablissement_valide'
        db.add_column('sigma_dossierorigine', 'autre_etablissement_valide', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.autre_etablissement_erreur'
        db.add_column('sigma_dossieraccueil', 'autre_etablissement_erreur', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.autre_etablissement_valide'
        db.add_column('sigma_dossieraccueil', 'autre_etablissement_valide', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
