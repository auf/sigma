...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DossierOrigine.faculte_url'
        db.delete_column('sigma_dossierorigine', 'faculte_url')

        # Deleting field 'DossierOrigine.faculte_telephone'
        db.delete_column('sigma_dossierorigine', 'faculte_telephone')

        # Deleting field 'DossierOrigine.faculte_courriel'
        db.delete_column('sigma_dossierorigine', 'faculte_courriel')

        # Deleting field 'DossierOrigine.faculte_fax'
        db.delete_column('sigma_dossierorigine', 'faculte_fax')

        # Deleting field 'DossierAccueil.faculte_url'
        db.delete_column('sigma_dossieraccueil', 'faculte_url')

        # Deleting field 'DossierAccueil.faculte_telephone'
        db.delete_column('sigma_dossieraccueil', 'faculte_telephone')

        # Deleting field 'DossierAccueil.faculte_courriel'
        db.delete_column('sigma_dossieraccueil', 'faculte_courriel')

        # Deleting field 'DossierAccueil.faculte_fax'
        db.delete_column('sigma_dossieraccueil', 'faculte_fax')
    
    
    def backwards(self, orm):
        
        # Adding field 'DossierOrigine.faculte_url'
        db.add_column('sigma_dossierorigine', 'faculte_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.faculte_telephone'
        db.add_column('sigma_dossierorigine', 'faculte_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.faculte_courriel'
        db.add_column('sigma_dossierorigine', 'faculte_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierOrigine.faculte_fax'
        db.add_column('sigma_dossierorigine', 'faculte_fax', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.faculte_url'
        db.add_column('sigma_dossieraccueil', 'faculte_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.faculte_telephone'
        db.add_column('sigma_dossieraccueil', 'faculte_telephone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.faculte_courriel'
        db.add_column('sigma_dossieraccueil', 'faculte_courriel', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'DossierAccueil.faculte_fax'
        db.add_column('sigma_dossieraccueil', 'faculte_fax', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
