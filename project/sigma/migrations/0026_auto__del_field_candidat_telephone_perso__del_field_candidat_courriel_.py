...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Candidat.courriel_pro'
        db.delete_column('sigma_candidat', 'courriel_pro')

        # Adding field 'Candidat.telephone_portable'
        db.rename_column('sigma_candidat', 'telephone_perso', 'telephone')

        # Adding field 'Candidat.courriel'
        db.rename_column('sigma_candidat', 'courriel_perso', 'courriel')

        # Adding field 'Candidat.telephone'
        db.rename_column('sigma_candidat', 'telephone_pro', 'telephone_portable')
    
    
    def backwards(self, orm):
        
        # Adding field 'Candidat.telephone_perso'
        db.add_column('sigma_candidat', 'telephone_perso', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Candidat.courriel_pro'
        db.add_column('sigma_candidat', 'courriel_pro', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Candidat.courriel_perso'
        db.add_column('sigma_candidat', 'courriel_perso', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Candidat.telephone_pro'
        db.add_column('sigma_candidat', 'telephone_pro', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Candidat.telephone_portable'
        db.delete_column('sigma_candidat', 'telephone_portable')

        # Deleting field 'Candidat.courriel'
        db.delete_column('sigma_candidat', 'courriel')

        # Deleting field 'Candidat.telephone'
        db.delete_column('sigma_candidat', 'telephone')
