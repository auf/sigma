...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AttributWCS'
        db.create_table('sigma_attributwcs', (
            ('dossier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attributs_wcs', to=orm['sigma.Dossier'])),
            ('valeur', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attribut', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('sigma', ['AttributWCS'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'AttributWCS'
        db.delete_table('sigma_attributwcs')
