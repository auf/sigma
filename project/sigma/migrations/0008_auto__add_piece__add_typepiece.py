...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sigma_piece', (
            ...
            ('valeur', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        ...
        db.create_table('sigma_typepiece', (
            ...
            ('requis', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('aide', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    models = {
        ...
        'sigma.piece': {
            ...
            'valeur': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'sigma.public': {
