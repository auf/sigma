...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sigma_note', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Note.user'
        db.alter_column('sigma_note', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sigma.Dossier']))
