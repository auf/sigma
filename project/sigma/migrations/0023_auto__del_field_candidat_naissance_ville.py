...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Candidat.naissance_ville'
        db.delete_column('sigma_candidat', 'naissance_ville')
    
    
    def backwards(self, orm):
        
        # Adding field 'Candidat.naissance_ville'
        db.add_column('sigma_candidat', 'naissance_ville', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
